...
%end
for i = 1:8
    z1 = Y((i-1)*4000+1:(i)*4000);
    zfft=fft(z1);
    spect1(:,i) = zfft;
end
%plot(abs(fft(Y1)))
spect = transpose(spect1);
%spect = transpose(spect1(:));
window_length = 4000;
fs = 8000;
figure
